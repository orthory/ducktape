            ...
            let __ice_content: ::ducktape_view_guest::wire::Node = {
                let __ice_rendered: ::ducktape_view_guest::wire::Node = {
                    let mut __children: ::std::vec::Vec<::ducktape_view_guest::wire::Node> =
                        ::std::vec::Vec::new();
                    __children.push({
let __ice_rendered: ::ducktape_view_guest::wire::Node = { let __ice_node_scope = format!("{}/document", "PagesEditorFixture"); { let __editor = &(self.document); let (__document, __on_document) = __editor.document(("app:document").to_owned(), __PagesEditorFixtureMessage::__EditDocument as fn(::ducktape_view_guest::EditorDocumentUpdate) -> __PagesEditorFixtureMessage); ::ducktape_view_guest::wire::Node::Editor { options: ::std::boxed::Box::new(::ducktape_view_guest::wire::EditorOptions { binding: ::std::option::Option::Some(::std::boxed::Box::new(crate::editor_binding::keys(self.history.clone(), self.menu.clone()).register({  move |__value| __PagesEditorFixtureMessage::Committed(__value) }, __PagesEditorFixtureMessage::__0T646f63756d656e74))), presentation: { let __presentation = crate::presentation::paint(__editor.state_view(), self.menu.clone(), self.paint_dark, self.commented.clone(), true); __presentation.validate(__editor.state_view().text).expect("invalid editor presentation"); Some(::std::boxed::Box::new(__presentation)) }, size: ::std::option::Option::None, padding: ::std::option::Option::None, line_height: ::std::option::Option::None, wrapping: ::std::option::Option::None, font: ::std::option::Option::None, style: ::ducktape_view_guest::wire::InputStyle { active: ::std::default::Default::default(), hovered: ::std::option::Option::None, focused: ::std::option::Option::None, focused_hovered: ::std::option::Option::None, disabled: ::std::option::Option::None, ..::std::default::Default::default() } }), key: __ice_node_scope.clone(), placeholder: ::std::string::String::new(), document: __document, on_document: __on_document, editable: true, width: ::std::option::Option::Some((640.0) as f32), height: ::std::option::Option::None, min_height: ::std::option::Option::Some((240.0) as f32), max_height: ::std::option::Option::Some((240.0) as f32) } } };
__ice_rendered
});
                    if (64000 > (((self.document).text()).len() as i64)) {
                        __children.push({
                            let __ice_rendered: ::ducktape_view_guest::wire::Node = {
                                let __ice_node_scope = format!("{}/echo", "PagesEditorFixture");
                    ...
                    __children.push({
                        let __ice_rendered: ::ducktape_view_guest::wire::Node = {
                            let __ice_node_scope =
                                format!("{}/formatting-notice", "PagesEditorFixture");
                            ::ducktape_view_guest::wire::Node::Text {
                                options: ::ducktape_view_guest::wire::TextOptions {
                                    height: ::std::option::Option::None,
                                    align_y: ::std::option::Option::None,
                    ...
                    __children.push({
                        let __ice_rendered: ::ducktape_view_guest::wire::Node = {
                            let __ice_node_scope = format!("{}/load-error", "PagesEditorFixture");
                            ::ducktape_view_guest::wire::Node::Text {
                                options: ::ducktape_view_guest::wire::TextOptions {
                                    height: ::std::option::Option::None,
                                    align_y: ::std::option::Option::None,
                        ...
                        let __ice_rendered: ::ducktape_view_guest::wire::Node =
                            ::ducktape_view_guest::wire::Node::Button {
                                ...
                                content: ::ducktape_view_guest::wire::ButtonContent::Label(
                                    ::std::string::String::from("Load document"),
                                ),
                                label: ::std::option::Option::None,
                                on_press: ::std::option::Option::Some(
                                ...
                                style: ::ducktape_view_guest::wire::ButtonStyle {
                                    ...
                                    hovered: ::std::option::Option::None,
                    ...
                    ::ducktape_view_guest::wire::Node::Linear {
                        ...
                        width: ::std::option::Option::Some(
                            ::ducktape_view_guest::wire::Length::Fixed((640.0) as f32),
                        ),
                        height: ::std::option::Option::None,
