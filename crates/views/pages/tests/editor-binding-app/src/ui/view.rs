...
#[allow(dead_code)] fn __ui_lang_check_pure_document_editor(arg0: ::std::string::String, arg1: ::std::vec::Vec<u8>) { let _: ::ducktape_view_guest::Editor = crate::document_ingress::document_editor(arg0, arg1); }
#[allow(dead_code)] fn __ui_lang_check_subscription_document_source(arg0: crate::document_ingress::DocumentSource) { let _: ::ducktape_view_guest::Subscription<crate::document_ingress::DocumentItem> = crate::document_ingress::document_source(arg0); }
...
if ((!(self.source.reference).is_empty()) && (self.source.reference != self.installed_source)) { ::ducktape_view_guest::Subscription::batch([crate::document_ingress::document_source(self.source.clone()).map(move |__value| __PagesEditorFixtureMessage::DocumentArrived(__value)),
