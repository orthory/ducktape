                        ...
                        content: Box::new({
                            ...
                            children
                                .push(::ducktape_view_guest::wire::Node::Text {
                                    ...
                                    width: None,
                                    align_x: None,
                                    content: ("Pages".to_owned()).to_string(),
                                });
                            children
                                .push(::ducktape_view_guest::wire::Node::Text {
                                    options: ::ducktape_view_guest::wire::TextOptions {
                                        ...
                                        children
                                            .push(::ducktape_view_guest::wire::Node::Button {
                                                ...
                                                content: ::ducktape_view_guest::wire::ButtonContent::Child(
                                                    Box::new(
                                                        self.icon(palette, format!("{}/Icon@680", use_scope), "plus", 16.),
                                                    ),
                                                ),
            ...
            ::ducktape_view_guest::wire::Node::Container {
                ...
                content: Box::new({
                    ...
                    children.push(::ducktape_view_guest::wire::Node::Text {
                        ...
                        width: None,
                        align_x: None,
                        content: ("Loading pages…".to_owned()).to_string(),
                    });
                    children.push(::ducktape_view_guest::wire::Node::Text {
                        options: ::ducktape_view_guest::wire::TextOptions {
                            height: None,
                        ...
                        width: None,
                        align_x: None,
                        content: ("Waiting for the page list.".to_owned()).to_string(),
                    });
                    ::ducktape_view_guest::wire::Node::Linear {
                        max_width: None,
                        clip: false,
            ...
            ::ducktape_view_guest::wire::Node::Container {
                ...
                content: Box::new({
                    ...
                    children.push(::ducktape_view_guest::wire::Node::Text {
                        ...
                        width: None,
                        align_x: None,
                        content: ("No page selected".to_owned()).to_string(),
                    });
                    children.push(::ducktape_view_guest::wire::Node::Text {
                        options: ::ducktape_view_guest::wire::TextOptions {
                            height: None,
                        ...
                        width: None,
                        align_x: None,
                        content: ("Create a page from the sidebar.".to_owned()).to_string(),
                    });
                    ::ducktape_view_guest::wire::Node::Linear {
                        max_width: None,
                        clip: false,
    ...
    ) -> ::ducktape_view_guest::wire::Node {
        {
            ...
            ::ducktape_view_guest::wire::Node::Container {
                ...
                content: Box::new(::ducktape_view_guest::wire::Node::Text {
                    ...
                    width: None,
                    align_x: None,
                    content: ("No pages matched that search.".to_owned()).to_string(),
                }),
            }
        }
    }
    pub(crate) fn comment_avatar(
    ...
    ) -> ::ducktape_view_guest::wire::Node {
        {
            ...
            ::ducktape_view_guest::wire::Node::Container {
                ...
                clip: false,
                key: node_scope.clone(),
                width: Some(::ducktape_view_guest::wire::Length::Fixed((22.0) as f32)),
                height: Some(::ducktape_view_guest::wire::Length::Fixed((22.0) as f32)),
                padding: None,
                align_x: Some(::ducktape_view_guest::wire::AlignX::Center),
                align_y: Some(::ducktape_view_guest::wire::AlignY::Center),
                ...
                content: Box::new(::ducktape_view_guest::wire::Node::Text {
                    ...
                    width: None,
                    align_x: None,
                    content: (initials.to_owned()).to_string(),
                }),
            }
        }
    }
                        ...
                        .push({
                            ...
                            children
                                .push(::ducktape_view_guest::wire::Node::Text {
                                    ...
                                    width: Some(::ducktape_view_guest::wire::Length::Fill),
                                    align_x: None,
                                    content: ("Delete this page".to_owned()).to_string(),
                                });
                            children
                                .push(::ducktape_view_guest::wire::Node::Button {
                                    checked: None,
                            ...
                            children
                                .push(::ducktape_view_guest::wire::Node::Text {
                                    ...
                                    content: (crate::host::keep_str(
                                            ...
                                            ::std::convert::AsRef::as_ref(&("Untitled")),
                                        )
                                        .to_owned())
                                        .to_string(),
                                });
                                        ...
                                        .push(::ducktape_view_guest::wire::Node::Button {
                                            ...
                                            content: ::ducktape_view_guest::wire::ButtonContent::Child(
                                                Box::new(::ducktape_view_guest::wire::Node::Text {
                                                    ...
                                                    width: None,
                                                    align_x: None,
                                                    content: ("Delete page".to_owned()).to_string(),
                                                }),
                                            ),
