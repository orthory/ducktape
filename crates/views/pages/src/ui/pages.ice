    ...
    row w=fill h=fill
      col w=fill h=fill
        ...
        stack
          ...
          // A stack layer keeps the document's size and scroll position.
          // Only the card intercepts the pointer: its idle cursor shields
          // blank areas from the editor below while child controls keep theirs.
          // The positioning box has no backdrop, so the rest of the page stays live.
