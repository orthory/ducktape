...
pub(crate) __ice_accessibility: ::ui_lang_runtime::Bridge<__PagesViewMessage>,
#[cfg(all(target_os = "windows", not(test)))]
pub(crate) __ice_accessibility_initial: ::std::option::Option<usize>,
#[cfg(all(target_os = "windows", not(test)))]
pub(crate) __ice_accessibility_pending: ::std::vec::Vec<__PagesViewMessage>,
...
__AccessibilitySnapshot(::std::boxed::Box<::ui_lang_runtime::Snapshot<__PagesViewMessage>>),
...
DocumentPointerReleased(::iced::mouse::Button),
...
__0T646f63756d656e74(::ui_lang_guest::EditorTransaction<__PagesViewMessage>),
__ExternNoop,
}
...
#[allow(dead_code)] fn __ui_lang_check_subscription_register(arg0: ::std::string::String, arg1: i64) { let _: ::iced::Subscription<crate::host::RegisterItem> = crate::host::register(arg0, arg1); }
#[allow(dead_code)] fn __ui_lang_check_subscription_search(arg0: ::std::string::String, arg1: i64) { let _: ::iced::Subscription<crate::host::SearchItem> = crate::host::search(arg0, arg1); }
#[allow(dead_code)] fn __ui_lang_check_subscription_acts() { let _: ::iced::Subscription<crate::host::ActItem> = crate::host::acts(); }
#[allow(dead_code)] fn __ui_lang_check_subscription_saves() { let _: ::iced::Subscription<crate::host::SaveItem> = crate::host::saves(); }
...
#[allow(dead_code)] fn __ui_lang_check_pure_document_text<'a>(arg0: &'a ::ui_lang_guest::Editor) { let _: ::std::string::String = crate::host::document_text(arg0); }
#[allow(dead_code)] fn __ui_lang_check_pure_document_editor<'a>(arg0: &'a str) { let _: ::ui_lang_guest::Editor = crate::host::document_editor(arg0); }
...
#[allow(dead_code)] fn __ui_lang_check_pure_presentation_notice<'a>(arg0: &'a ::ui_lang_guest::Editor, arg1: &'a crate::editor_view::PreparedPresentation) { let _: ::std::string::String = crate::editor_view::presentation_notice(arg0, arg1); }
...
#[allow(dead_code)] fn __ui_lang_check_editor_highlighter_paint(arg0: crate::editor_view::PreparedPresentation) { let __editor = ::ui_lang_guest::Editor::default(); let _: ::ui_lang_guest::wire::editor_presentation::EditorPresentation = crate::editor_view::paint(__editor.state_view(), arg0); }
#[allow(dead_code)] fn __ui_lang_check_pure_document_presentation<'a>(arg0: &'a ::ui_lang_guest::Editor, arg1: crate::editor_binding::MenuState, arg2: bool, arg3: ::std::vec::Vec<i64>, arg4: ::std::vec::Vec<crate::document_sync::CommentMark>, arg5: bool, arg6: crate::editor_view::EditorReserve) { let _: crate::editor_view::PreparedPresentation = crate::editor_view::document_presentation(arg0, arg1, arg2, arg3, arg4, arg5, arg6); }
}
__ice_generated_items_506167657356696577! {
#[allow(unused_parens)]
impl PagesView {
...
fn __app_theme(__ice_palette: __IcePalette) -> ::iced::Theme {
         ...
         let __theme =
::iced::Theme::custom(::std::format!("PagesView/{}", __ice_palette.name), ::iced::theme::Palette {
...
fn __title(&self) -> ::std::string::String { "Pages".to_owned() }
}
}
__ice_generated_items_506167657356696577! {
#[allow(unused_parens)]
...
document: ::ui_lang_guest::Editor::new("".to_owned()),
...
pub(crate) fn __snapshot(&self) -> ::std::result::Result<::std::vec::Vec<u8>, ::std::string::String> { ::ui_lang_guest::wire::Snapshot {schema: ::std::string::String::from(Self::__SNAPSHOT_SCHEMA), state: ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("PagesView"), fields: vec![(::std::string::String::from("pointer_y"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.pointer_y))), (::std::string::String::from("comment_anchor_y"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.comment_anchor_y))), (::std::string::String::from("comment_anchor_line"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.comment_anchor_line))), (::std::string::String::from("comments_card_height"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.comments_card_height))), (::std::string::String::from("document_reserve"), ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("EditorReserve"), fields: ::std::vec![(::std::string::String::from("line"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(&self.document_reserve).line))), (::std::string::String::from("height"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(&self.document_reserve).height)))] }), (::std::string::String::from("document_focused"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.document_focused))), (::std::string::String::from("focus_query"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.focus_query))), (::std::string::String::from("document_paint"), ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("PreparedPresentation"), fields: ::std::vec![(::std::string::String::from("reference"), ::ui_lang_guest::wire::SnapshotValue::Bytes((&(&self.document_paint).reference).clone())), (::std::string::String::from("data"), ::ui_lang_guest::wire::SnapshotValue::Bytes((&(&self.document_paint).data).clone())), (::std::string::String::from("notice"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&self.document_paint).notice)))] }), (::std::string::String::from("document"), ::ui_lang_guest::wire::SnapshotValue::Bytes((&self.document).snapshot())), (::std::string::String::from("document_history"), ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("HistoryState"), fields: ::std::vec![(::std::string::String::from("snapshot"), ::ui_lang_guest::wire::SnapshotValue::Bytes((&(&self.document_history).snapshot).clone()))] }), (::std::string::String::from("document_menu"), ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("MenuState"), fields: ::std::vec![(::std::string::String::from("snapshot"), ::ui_lang_guest::wire::SnapshotValue::Bytes((&(&self.document_menu).snapshot).clone()))] }), (::std::string::String::from("document_error"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.document_error))), (::std::string::String::from("document_dark"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.document_dark))), (::std::string::String::from("document_commented"), ::ui_lang_guest::wire::SnapshotValue::List((&self.document_commented).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::I64(*(__item))).collect())), (::std::string::String::from("document_marks"), ::ui_lang_guest::wire::SnapshotValue::List((&self.document_marks).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("CommentMark"), fields: ::std::vec![(::std::string::String::from("line"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).line))), (::std::string::String::from("count"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).count)))] }).collect())), (::std::string::String::from("active_palette"), match &self.active_palette { AppTheme::App => ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("AppTheme"), fields: vec![(::std::string::String::from("app"), ::ui_lang_guest::wire::SnapshotValue::Unit)] }, AppTheme::AppDark => ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("AppTheme"), fields: vec![(::std::string::String::from("app_dark"), ::ui_lang_guest::wire::SnapshotValue::Unit)] } }), (::std::string::String::from("connected"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.connected))), (::std::string::String::from("chain"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.chain))), (::std::string::String::from("route_serial"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.route_serial))), (::std::string::String::from("register_serial"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.register_serial))), (::std::string::String::from("loading"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.loading))), (::std::string::String::from("busy"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.busy))), (::std::string::String::from("host_error"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.host_error))), (::std::string::String::from("page_link"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.page_link))), (::std::string::String::from("pages"), ::ui_lang_guest::wire::SnapshotValue::List((&self.pages).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("PageItem"), fields: ::std::vec![(::std::string::String::from("id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).id))), (::std::string::String::from("title"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).title))), (::std::string::String::from("parent"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).parent))), (::std::string::String::from("prefix"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).prefix))), (::std::string::String::from("child_count"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).child_count)))] }).collect())), (::std::string::String::from("blocks"), ::ui_lang_guest::wire::SnapshotValue::List((&self.blocks).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("PageBlock"), fields: ::std::vec![(::std::string::String::from("key"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).key))), (::std::string::String::from("id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).id))), (::std::string::String::from("parent"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).parent))), (::std::string::String::from("kind"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).kind))), (::std::string::String::from("text"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).text))), (::std::string::String::from("checked"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&(__item).checked))), (::std::string::String::from("prefix"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).prefix))), (::std::string::String::from("child_count"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).child_count)))] }).collect())), (::std::string::String::from("pages_viewport_width"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.pages_viewport_width))), (::std::string::String::from("pages_viewport_height"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.pages_viewport_height))), (::std::string::String::from("pages_pane_width"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.pages_pane_width))), (::std::string::String::from("sidebar_width"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.sidebar_width))), (::std::string::String::from("page_menu_open"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.page_menu_open))), (::std::string::String::from("page_create_open"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.page_create_open))), (::std::string::String::from("active_page"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.active_page))), (::std::string::String::from("active_page_title"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.active_page_title))), (::std::string::String::from("active_page_parent"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.active_page_parent))), (::std::string::String::from("page_searching"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.page_searching))), (::std::string::String::from("page_search_hits"), ::ui_lang_guest::wire::SnapshotValue::List((&self.page_search_hits).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("PageSearchHit"), fields: ::std::vec![(::std::string::String::from("page_id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).page_id))), (::std::string::String::from("page_title"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).page_title))), (::std::string::String::from("block_id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).block_id))), (::std::string::String::from("kind"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).kind))), (::std::string::String::from("text"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).text)))] }).collect())), (::std::string::String::from("page_search_query"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.page_search_query))), (::std::string::String::from("page_search_serial"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.page_search_serial))), (::std::string::String::from("page_delete_armed"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.page_delete_armed))), (::std::string::String::from("autosave"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.autosave))), (::std::string::String::from("page_refusal"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.page_refusal))), (::std::string::String::from("subpages"), ::ui_lang_guest::wire::SnapshotValue::List((&self.subpages).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("Subpage"), fields: ::std::vec![(::std::string::String::from("id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).id))), (::std::string::String::from("title"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).title)))] }).collect())), (::std::string::String::from("orphaned_comment_drafts"), ::ui_lang_guest::wire::SnapshotValue::List((&self.orphaned_comment_drafts).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(__item))).collect())), (::std::string::String::from("block_comments_open"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.block_comments_open))), (::std::string::String::from("scope_target"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.scope_target))), (::std::string::String::from("scope_pinned"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.scope_pinned))), (::std::string::String::from("thread_total"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.thread_total))), (::std::string::String::from("comment_rows"), ::ui_lang_guest::wire::SnapshotValue::List((&self.comment_rows).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("PageCommentThreadRow"), fields: ::std::vec![(::std::string::String::from("thread"), ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("PageCommentThread"), fields: ::std::vec![(::std::string::String::from("id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&(__item).thread).id))), (::std::string::String::from("target"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&(__item).thread).target))), (::std::string::String::from("author"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&(__item).thread).author))), (::std::string::String::from("meta"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&(__item).thread).meta))), (::std::string::String::from("resolved"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&(&(__item).thread).resolved))), (::std::string::String::from("comment_count"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(&(__item).thread).comment_count))), (::std::string::String::from("comments"), ::ui_lang_guest::wire::SnapshotValue::List((&(&(__item).thread).comments).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("PageComment"), fields: ::std::vec![(::std::string::String::from("id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).id))), (::std::string::String::from("ordinal"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).ordinal))), (::std::string::String::from("author"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).author))), (::std::string::String::from("meta"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).meta))), (::std::string::String::from("text"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).text)))] }).collect()))] }), (::std::string::String::from("anchor"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).anchor)))] }).collect())), (::std::string::String::from("threads_loading"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.threads_loading))), (::std::string::String::from("commented_hits"), ::ui_lang_guest::wire::SnapshotValue::List((&self.commented_hits).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(__item))).collect())), (::std::string::String::from("reply_thread"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.reply_thread))), (::std::string::String::from("expanded_threads"), ::ui_lang_guest::wire::SnapshotValue::List((&self.expanded_threads).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(__item))).collect())), (::std::string::String::from("resolved_open"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.resolved_open))), (::std::string::String::from("page_draft"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.page_draft))), (::std::string::String::from("page_search_draft"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.page_search_draft))), (::std::string::String::from("block_comment_draft"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.block_comment_draft))), (::std::string::String::from("reply_draft"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.reply_draft))), (::std::string::String::from("pending_page"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.pending_page))), (::std::string::String::from("pending_comment"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.pending_comment))), (::std::string::String::from("page_saved_text"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.page_saved_text))), (::std::string::String::from("buffer_page"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.buffer_page))), (::std::string::String::from("page_inflight_text"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.page_inflight_text))), (::std::string::String::from("sent"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.sent)))] }}.encode() }
pub(crate) fn __restore(__bytes: &[u8]) -> ::std::result::Result<Self, ::std::string::String> { let __snapshot = ::ui_lang_guest::wire::Snapshot::decode(__bytes)?; if __snapshot.schema != Self::__SNAPSHOT_SCHEMA { return ::std::result::Result::Err(::std::string::String::from("snapshot schema mismatch")); } let __value = __snapshot.state; ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record {name: __name, fields: __fields} = __value else { return ::std::option::Option::None; }; if __name != "PagesView" || __fields.len() != 64 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __value) = __fields.next()?; if __name != "pointer_y" { return ::std::option::Option::None; } let pointer_y: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "comment_anchor_y" { return ::std::option::Option::None; } let comment_anchor_y: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "comment_anchor_line" { return ::std::option::Option::None; } let comment_anchor_line: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "comments_card_height" { return ::std::option::Option::None; } let comments_card_height: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "document_reserve" { return ::std::option::Option::None; } let document_reserve: crate::editor_view::EditorReserve = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __value else { return ::std::option::Option::None; }; if __name != "EditorReserve" || __fields.len() != 2 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "line" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "height" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::editor_view::EditorReserve { line: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, height: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })())?; let (__name, __value) = __fields.next()?; if __name != "document_focused" { return ::std::option::Option::None; } let document_focused: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "focus_query" { return ::std::option::Option::None; } let focus_query: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "document_paint" { return ::std::option::Option::None; } let document_paint: crate::editor_view::PreparedPresentation = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __value else { return ::std::option::Option::None; }; if __name != "PreparedPresentation" || __fields.len() != 3 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "reference" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "data" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "notice" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::editor_view::PreparedPresentation { reference: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Bytes(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, data: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Bytes(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, notice: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })())?; let (__name, __value) = __fields.next()?; if __name != "document" { return ::std::option::Option::None; } let document: ::ui_lang_guest::Editor = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bytes(bytes) => ::ui_lang_guest::Editor::restore(&bytes), _ => None })?; let (__name, __value) = __fields.next()?; if __name != "document_history" { return ::std::option::Option::None; } let document_history: crate::editor_binding::HistoryState = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __value else { return ::std::option::Option::None; }; if __name != "HistoryState" || __fields.len() != 1 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "snapshot" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::editor_binding::HistoryState { snapshot: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Bytes(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })())?; let (__name, __value) = __fields.next()?; if __name != "document_menu" { return ::std::option::Option::None; } let document_menu: crate::editor_binding::MenuState = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __value else { return ::std::option::Option::None; }; if __name != "MenuState" || __fields.len() != 1 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "snapshot" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::editor_binding::MenuState { snapshot: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Bytes(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })())?; let (__name, __value) = __fields.next()?; if __name != "document_error" { return ::std::option::Option::None; } let document_error: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "document_dark" { return ::std::option::Option::None; } let document_dark: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "document_commented" { return ::std::option::Option::None; } let document_commented: ::std::vec::Vec<i64> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| match __item { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None }).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "document_marks" { return ::std::option::Option::None; } let document_marks: ::std::vec::Vec<crate::document_sync::CommentMark> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "CommentMark" || __fields.len() != 2 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "line" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "count" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::document_sync::CommentMark { line: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, count: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "active_palette" { return ::std::option::Option::None; } let active_palette: AppTheme = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __value else { return ::std::option::Option::None; }; if __name != "AppTheme" || __fields.len() != 1 { return ::std::option::Option::None; } let (__variant, __payload) = __fields.into_iter().next()?; match __variant.as_str() { "app" => matches!(__payload, ::ui_lang_guest::wire::SnapshotValue::Unit).then_some(AppTheme::App), "app_dark" => matches!(__payload, ::ui_lang_guest::wire::SnapshotValue::Unit).then_some(AppTheme::AppDark), _ => ::std::option::Option::None } })())?; let (__name, __value) = __fields.next()?; if __name != "connected" { return ::std::option::Option::None; } let connected: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "chain" { return ::std::option::Option::None; } let chain: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "route_serial" { return ::std::option::Option::None; } let route_serial: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "register_serial" { return ::std::option::Option::None; } let register_serial: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "loading" { return ::std::option::Option::None; } let loading: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "busy" { return ::std::option::Option::None; } let busy: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "host_error" { return ::std::option::Option::None; } let host_error: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_link" { return ::std::option::Option::None; } let page_link: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "pages" { return ::std::option::Option::None; } let pages: ::std::vec::Vec<crate::host::PageItem> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "PageItem" || __fields.len() != 5 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "id" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "title" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "parent" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "prefix" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "child_count" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::PageItem { id: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, title: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, parent: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, prefix: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, child_count: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "blocks" { return ::std::option::Option::None; } let blocks: ::std::vec::Vec<crate::document_sync::PageBlock> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "PageBlock" || __fields.len() != 8 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "key" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "id" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "parent" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "kind" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "text" { return ::std::option::Option::None; } let (__name, __field_5) = __fields.next()?; if __name != "checked" { return ::std::option::Option::None; } let (__name, __field_6) = __fields.next()?; if __name != "prefix" { return ::std::option::Option::None; } let (__name, __field_7) = __fields.next()?; if __name != "child_count" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::document_sync::PageBlock { key: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, id: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, parent: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, kind: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, text: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, checked: (match __field_5 { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, prefix: (match __field_6 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, child_count: (match __field_7 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "pages_viewport_width" { return ::std::option::Option::None; } let pages_viewport_width: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "pages_viewport_height" { return ::std::option::Option::None; } let pages_viewport_height: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "pages_pane_width" { return ::std::option::Option::None; } let pages_pane_width: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "sidebar_width" { return ::std::option::Option::None; } let sidebar_width: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_menu_open" { return ::std::option::Option::None; } let page_menu_open: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_create_open" { return ::std::option::Option::None; } let page_create_open: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "active_page" { return ::std::option::Option::None; } let active_page: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "active_page_title" { return ::std::option::Option::None; } let active_page_title: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "active_page_parent" { return ::std::option::Option::None; } let active_page_parent: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_searching" { return ::std::option::Option::None; } let page_searching: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_search_hits" { return ::std::option::Option::None; } let page_search_hits: ::std::vec::Vec<crate::host::PageSearchHit> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "PageSearchHit" || __fields.len() != 5 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "page_id" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "page_title" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "block_id" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "kind" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "text" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::PageSearchHit { page_id: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, page_title: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, block_id: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, kind: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, text: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_search_query" { return ::std::option::Option::None; } let page_search_query: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_search_serial" { return ::std::option::Option::None; } let page_search_serial: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_delete_armed" { return ::std::option::Option::None; } let page_delete_armed: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "autosave" { return ::std::option::Option::None; } let autosave: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_refusal" { return ::std::option::Option::None; } let page_refusal: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "subpages" { return ::std::option::Option::None; } let subpages: ::std::vec::Vec<crate::host::Subpage> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "Subpage" || __fields.len() != 2 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "id" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "title" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::Subpage { id: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, title: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "orphaned_comment_drafts" { return ::std::option::Option::None; } let orphaned_comment_drafts: ::std::vec::Vec<::std::string::String> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| match __item { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None }).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "block_comments_open" { return ::std::option::Option::None; } let block_comments_open: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "scope_target" { return ::std::option::Option::None; } let scope_target: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "scope_pinned" { return ::std::option::Option::None; } let scope_pinned: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "thread_total" { return ::std::option::Option::None; } let thread_total: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "comment_rows" { return ::std::option::Option::None; } let comment_rows: ::std::vec::Vec<crate::host::PageCommentThreadRow> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "PageCommentThreadRow" || __fields.len() != 2 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "thread" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "anchor" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::PageCommentThreadRow { thread: ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __field_0 else { return ::std::option::Option::None; }; if __name != "PageCommentThread" || __fields.len() != 7 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "id" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "target" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "author" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "meta" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "resolved" { return ::std::option::Option::None; } let (__name, __field_5) = __fields.next()?; if __name != "comment_count" { return ::std::option::Option::None; } let (__name, __field_6) = __fields.next()?; if __name != "comments" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::PageCommentThread { id: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, target: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, author: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, meta: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, resolved: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, comment_count: (match __field_5 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, comments: (match __field_6 { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "PageComment" || __fields.len() != 5 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "id" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "ordinal" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "author" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "meta" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "text" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::PageComment { id: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, ordinal: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, author: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, meta: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, text: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })? }) })())?, anchor: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "threads_loading" { return ::std::option::Option::None; } let threads_loading: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "commented_hits" { return ::std::option::Option::None; } let commented_hits: ::std::vec::Vec<::std::string::String> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| match __item { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None }).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "reply_thread" { return ::std::option::Option::None; } let reply_thread: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "expanded_threads" { return ::std::option::Option::None; } let expanded_threads: ::std::vec::Vec<::std::string::String> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| match __item { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None }).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "resolved_open" { return ::std::option::Option::None; } let resolved_open: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_draft" { return ::std::option::Option::None; } let page_draft: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_search_draft" { return ::std::option::Option::None; } let page_search_draft: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "block_comment_draft" { return ::std::option::Option::None; } let block_comment_draft: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "reply_draft" { return ::std::option::Option::None; } let reply_draft: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "pending_page" { return ::std::option::Option::None; } let pending_page: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "pending_comment" { return ::std::option::Option::None; } let pending_comment: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_saved_text" { return ::std::option::Option::None; } let page_saved_text: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "buffer_page" { return ::std::option::Option::None; } let buffer_page: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "page_inflight_text" { return ::std::option::Option::None; } let page_inflight_text: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "sent" { return ::std::option::Option::None; } let sent: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; ::std::option::Option::Some(Self::__restore_state(pointer_y, comment_anchor_y, comment_anchor_line, comments_card_height, document_reserve, document_focused, focus_query, document_paint, document, document_history, document_menu, document_error, document_dark, document_commented, document_marks, active_palette, connected, chain, route_serial, register_serial, loading, busy, host_error, page_link, pages, blocks, pages_viewport_width, pages_viewport_height, pages_pane_width, sidebar_width, page_menu_open, page_create_open, active_page, active_page_title, active_page_parent, page_searching, page_search_hits, page_search_query, page_search_serial, page_delete_armed, autosave, page_refusal, subpages, orphaned_comment_drafts, block_comments_open, scope_target, scope_pinned, thread_total, comment_rows, threads_loading, commented_hits, reply_thread, expanded_threads, resolved_open, page_draft, page_search_draft, block_comment_draft, reply_draft, pending_page, pending_comment, page_saved_text, buffer_page, page_inflight_text, sent)) })()).ok_or_else(|| ::std::string::String::from("snapshot state mismatch")) }
}
}
__ice_generated_items_506167657356696577! {
#[allow(unused_parens)]
...
#[allow(unused_parens)]
impl PagesView {
fn __subscription(&self) -> ::iced::Subscription<__PagesViewMessage> {
::iced::Subscription::batch([
::ui_lang_guest::mouse::observe(::iced::event::listen_with(|__event, _, _| { match __event { ::iced::Event::Mouse(::iced::mouse::Event::CursorMoved { position }) => ::std::option::Option::Some((position.x as f64, position.y as f64)), _ => ::std::option::Option::None } }).map(move |__value| __PagesViewMessage::CommentPointerMoved(__value.0, __value.1))),
::ui_lang_guest::mouse::observe(::iced::event::listen_with(|__event, _, _| { match __event { ::iced::Event::Mouse(::iced::mouse::Event::ButtonReleased(button)) => ::std::option::Option::Some(button), _ => ::std::option::Option::None } }).map(move |__value| __PagesViewMessage::DocumentPointerReleased(__value))),
::iced::event::listen_with(|__event, _, _| { match __event { ::iced::Event::Keyboard(__event) => { match __event { ::iced::keyboard::Event::KeyReleased { key, modified_key, physical_key, location, modifiers } => ::std::option::Option::Some(__IceKeyRelease { key, modified_key, physical_key, location, modifiers }), _ => ::std::option::Option::None } }, _ => ::std::option::Option::None } }).map(move |__value| __PagesViewMessage::DocumentKeyReleased(__value)),
::ui_lang_guest::events::observe(::iced::event::listen_with(|__event, _, __id| { match __event { ::iced::Event::Window(__event) => { matches!(__event, ::iced::window::Event::Focused).then_some(()) }, _ => ::std::option::Option::None } }).map(move |__value| __PagesViewMessage::DocumentWindowFocused), ::ui_lang_guest::wire::events::Interest { focus: true, ..::std::default::Default::default() }),
::ui_lang_guest::events::observe(::iced::event::listen_with(|__event, _, __id| { match __event { ::iced::Event::Window(__event) => { matches!(__event, ::iced::window::Event::Unfocused).then_some(()) }, _ => ::std::option::Option::None } }).map(move |__value| __PagesViewMessage::DocumentWindowUnfocused), ::ui_lang_guest::wire::events::Interest { focus: true, ..::std::default::Default::default() }),
crate::host::session().map(move |__value| __PagesViewMessage::SessionArrived(__value)),
if self.connected { ::iced::Subscription::batch([crate::host::register(self.active_page.to_owned(), self.register_serial).map(move |__value| __PagesViewMessage::RegisterArrived(__value)),
]) } else { ::iced::Subscription::none() },
if (self.connected && (!(self.page_search_query).is_empty())) { ::iced::Subscription::batch([crate::host::search(self.page_search_query.to_owned(), self.page_search_serial).map(move |__value| __PagesViewMessage::SearchArrived(__value)),
]) } else { ::iced::Subscription::none() },
...
if ((((self.connected && (!self.loading)) && (!self.busy)) && (!(self.active_page).is_empty())) && (self.active_page == self.buffer_page)) { ::iced::Subscription::batch([::ui_lang_guest::every(::std::time::Duration::from_millis(900)).map(move |__value| __PagesViewMessage::PageAutosaveTick),
]) } else { ::iced::Subscription::none() },
])
}
}
