...
pub(crate) fn __ice_test_scopes_files_screen(&self) -> ::std::vec::Vec<::std::string::String> { let mut __scopes: ::std::vec::Vec<::std::string::String> = self.__ice_component_046696c657353637265656e.keys().cloned().collect(); for __scope in ::ui_lang_runtime::testing::component_sightings("FilesScreen") { if !__scopes.contains(&__scope) { __scopes.push(__scope); } } __scopes }
...
pub(crate) draft: ::ui_lang_guest::Editor,
...
__EditDraft(::ui_lang_guest::EditorDocumentUpdate),
__0T6472616674(::ui_lang_guest::EditorTransaction<__FilesViewMessage>),
__ExternNoop,
}
...
#[allow(dead_code)] fn __ui_lang_check_subscription_listing(arg0: i64, arg1: ::std::string::String) { let _: ::iced::Subscription<crate::host::ListingItem> = crate::host::listing(arg0, arg1); }
#[allow(dead_code)] fn __ui_lang_check_subscription_preview(arg0: i64, arg1: ::std::string::String) { let _: ::iced::Subscription<crate::host::PreviewItem> = crate::host::preview(arg0, arg1); }
#[allow(dead_code)] fn __ui_lang_check_subscription_diff(arg0: i64, arg1: ::std::string::String) { let _: ::iced::Subscription<crate::host::DiffItem> = crate::host::diff(arg0, arg1); }
...
notice: "".to_owned(),
new_name: "".to_owned(),
draft: ::ui_lang_guest::Editor::new("".to_owned()),
editing: false,
...
__ice_rev: [::ui_lang_runtime::rev::seed(); 43],
...
pub(crate) fn __snapshot(&self) -> ::std::result::Result<::std::vec::Vec<u8>, ::std::string::String> { ::ui_lang_guest::wire::Snapshot {schema: ::std::string::String::from(Self::__SNAPSHOT_SCHEMA), state: ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FilesView"), fields: vec![(::std::string::String::from("active_palette"), match &self.active_palette { AppTheme::App => ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("AppTheme"), fields: vec![(::std::string::String::from("app"), ::ui_lang_guest::wire::SnapshotValue::Unit)] }, AppTheme::AppDark => ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("AppTheme"), fields: vec![(::std::string::String::from("app_dark"), ::ui_lang_guest::wire::SnapshotValue::Unit)] } }), (::std::string::String::from("connected"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.connected))), (::std::string::String::from("dark"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.dark))), (::std::string::String::from("chain"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.chain))), (::std::string::String::from("generation"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.generation))), (::std::string::String::from("route_serial"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.route_serial))), (::std::string::String::from("path"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.path))), (::std::string::String::from("listed"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.listed))), (::std::string::String::from("entries"), ::ui_lang_guest::wire::SnapshotValue::List((&self.entries).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FsEntry"), fields: ::std::vec![(::std::string::String::from("key"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).key))), (::std::string::String::from("path"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).path))), (::std::string::String::from("name"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).name))), (::std::string::String::from("kind"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).kind))), (::std::string::String::from("size"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).size))), (::std::string::String::from("object"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).object)))] }).collect())), (::std::string::String::from("directories"), ::ui_lang_guest::wire::SnapshotValue::List((&self.directories).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FsEntry"), fields: ::std::vec![(::std::string::String::from("key"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).key))), (::std::string::String::from("path"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).path))), (::std::string::String::from("name"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).name))), (::std::string::String::from("kind"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).kind))), (::std::string::String::from("size"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).size))), (::std::string::String::from("object"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).object)))] }).collect())), (::std::string::String::from("history"), ::ui_lang_guest::wire::SnapshotValue::List((&self.history).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FsSnapshot"), fields: ::std::vec![(::std::string::String::from("id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).id))), (::std::string::String::from("short_id"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).short_id))), (::std::string::String::from("author"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).author))), (::std::string::String::from("height"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(__item).height))), (::std::string::String::from("message"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).message)))] }).collect())), (::std::string::String::from("omitted"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.omitted))), (::std::string::String::from("diff_omitted"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.diff_omitted))), (::std::string::String::from("preview_path"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.preview_path))), (::std::string::String::from("preview_entry"), ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FsEntry"), fields: ::std::vec![(::std::string::String::from("key"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(&self.preview_entry).key))), (::std::string::String::from("path"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&self.preview_entry).path))), (::std::string::String::from("name"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&self.preview_entry).name))), (::std::string::String::from("kind"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&self.preview_entry).kind))), (::std::string::String::from("size"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&(&self.preview_entry).size))), (::std::string::String::from("object"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(&self.preview_entry).object)))] }), (::std::string::String::from("preview_base"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.preview_base))), (::std::string::String::from("preview_text"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.preview_text))), (::std::string::String::from("preview_display_text"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.preview_display_text))), (::std::string::String::from("preview_clipped"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.preview_clipped))), (::std::string::String::from("preview_truncated"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.preview_truncated))), (::std::string::String::from("preview_binary"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.preview_binary))), (::std::string::String::from("preview_picture"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.preview_picture))), (::std::string::String::from("preview_width"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.preview_width))), (::std::string::String::from("preview_height"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.preview_height))), (::std::string::String::from("delete_target"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.delete_target))), (::std::string::String::from("diff_from"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.diff_from))), (::std::string::String::from("diff"), ::ui_lang_guest::wire::SnapshotValue::List((&self.diff).iter().map(|__item| ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FsDiffEntry"), fields: ::std::vec![(::std::string::String::from("path"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).path))), (::std::string::String::from("kind"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&(__item).kind)))] }).collect())), (::std::string::String::from("acting"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.acting))), (::std::string::String::from("saving"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.saving))), (::std::string::String::from("notice"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.notice))), (::std::string::String::from("new_name"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.new_name))), (::std::string::String::from("draft"), ::ui_lang_guest::wire::SnapshotValue::Bytes((&self.draft).snapshot())), (::std::string::String::from("editing"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.editing))), (::std::string::String::from("draft_chain"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.draft_chain))), (::std::string::String::from("draft_path"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.draft_path))), (::std::string::String::from("draft_base"), ::ui_lang_guest::wire::SnapshotValue::Str(::std::string::ToString::to_string(&self.draft_base))), (::std::string::String::from("draft_id"), ::ui_lang_guest::wire::SnapshotValue::I64(*(&self.draft_id))), (::std::string::String::from("sent"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&self.sent))), (::std::string::String::from("viewport_width"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.viewport_width))), (::std::string::String::from("viewport_height"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.viewport_height))), (::std::string::String::from("tree_width"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.tree_width))), (::std::string::String::from("preview_pane_height"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.preview_pane_height))), (::std::string::String::from("object_width"), ::ui_lang_guest::wire::SnapshotValue::F64(*(&self.object_width))), (::std::string::String::from("__ice_component_046696c657353637265656e"), { let __values = &self.__ice_component_046696c657353637265656e; let mut __scopes = __values.keys().collect::<::std::vec::Vec<_>>(); __scopes.sort(); ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FilesScreen instances"), fields: __scopes.into_iter().map(|__scope| { let __component = &__values[__scope]; (__scope.clone(), ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FilesScreen"), fields: vec![(::std::string::String::from("history_open"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&__component.history_open)))] }) }).collect() } }), (::std::string::String::from("__ice_component_046696c657353637265656e_initial"), { let __component = &self.__ice_component_046696c657353637265656e_initial; ::ui_lang_guest::wire::SnapshotValue::Record { name: ::std::string::String::from("FilesScreen"), fields: vec![(::std::string::String::from("history_open"), ::ui_lang_guest::wire::SnapshotValue::Bool(*(&__component.history_open)))] } })] }}.encode() }
pub(crate) fn __restore(__bytes: &[u8]) -> ::std::result::Result<Self, ::std::string::String> { let __snapshot = ::ui_lang_guest::wire::Snapshot::decode(__bytes)?; if __snapshot.schema != Self::__SNAPSHOT_SCHEMA { return ::std::result::Result::Err(::std::string::String::from("snapshot schema mismatch")); } let __value = __snapshot.state; ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record {name: __name, fields: __fields} = __value else { return ::std::option::Option::None; }; if __name != "FilesView" || __fields.len() != 45 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __value) = __fields.next()?; if __name != "active_palette" { return ::std::option::Option::None; } let active_palette: AppTheme = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __value else { return ::std::option::Option::None; }; if __name != "AppTheme" || __fields.len() != 1 { return ::std::option::Option::None; } let (__variant, __payload) = __fields.into_iter().next()?; match __variant.as_str() { "app" => matches!(__payload, ::ui_lang_guest::wire::SnapshotValue::Unit).then_some(AppTheme::App), "app_dark" => matches!(__payload, ::ui_lang_guest::wire::SnapshotValue::Unit).then_some(AppTheme::AppDark), _ => ::std::option::Option::None } })())?; let (__name, __value) = __fields.next()?; if __name != "connected" { return ::std::option::Option::None; } let connected: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "dark" { return ::std::option::Option::None; } let dark: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "chain" { return ::std::option::Option::None; } let chain: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "generation" { return ::std::option::Option::None; } let generation: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "route_serial" { return ::std::option::Option::None; } let route_serial: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "path" { return ::std::option::Option::None; } let path: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "listed" { return ::std::option::Option::None; } let listed: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "entries" { return ::std::option::Option::None; } let entries: ::std::vec::Vec<crate::host::FsEntry> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "FsEntry" || __fields.len() != 6 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "key" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "path" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "name" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "kind" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "size" { return ::std::option::Option::None; } let (__name, __field_5) = __fields.next()?; if __name != "object" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::FsEntry { key: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, path: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, name: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, kind: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, size: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, object: (match __field_5 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "directories" { return ::std::option::Option::None; } let directories: ::std::vec::Vec<crate::host::FsEntry> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "FsEntry" || __fields.len() != 6 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "key" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "path" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "name" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "kind" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "size" { return ::std::option::Option::None; } let (__name, __field_5) = __fields.next()?; if __name != "object" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::FsEntry { key: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, path: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, name: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, kind: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, size: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, object: (match __field_5 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "history" { return ::std::option::Option::None; } let history: ::std::vec::Vec<crate::host::FsSnapshot> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "FsSnapshot" || __fields.len() != 5 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "id" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "short_id" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "author" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "height" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "message" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::FsSnapshot { id: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, short_id: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, author: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, height: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, message: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "omitted" { return ::std::option::Option::None; } let omitted: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "diff_omitted" { return ::std::option::Option::None; } let diff_omitted: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_path" { return ::std::option::Option::None; } let preview_path: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_entry" { return ::std::option::Option::None; } let preview_entry: crate::host::FsEntry = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __value else { return ::std::option::Option::None; }; if __name != "FsEntry" || __fields.len() != 6 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "key" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "path" { return ::std::option::Option::None; } let (__name, __field_2) = __fields.next()?; if __name != "name" { return ::std::option::Option::None; } let (__name, __field_3) = __fields.next()?; if __name != "kind" { return ::std::option::Option::None; } let (__name, __field_4) = __fields.next()?; if __name != "size" { return ::std::option::Option::None; } let (__name, __field_5) = __fields.next()?; if __name != "object" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::FsEntry { key: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, path: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, name: (match __field_2 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, kind: (match __field_3 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, size: (match __field_4 { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, object: (match __field_5 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })())?; let (__name, __value) = __fields.next()?; if __name != "preview_base" { return ::std::option::Option::None; } let preview_base: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_text" { return ::std::option::Option::None; } let preview_text: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_display_text" { return ::std::option::Option::None; } let preview_display_text: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_clipped" { return ::std::option::Option::None; } let preview_clipped: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_truncated" { return ::std::option::Option::None; } let preview_truncated: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_binary" { return ::std::option::Option::None; } let preview_binary: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_picture" { return ::std::option::Option::None; } let preview_picture: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_width" { return ::std::option::Option::None; } let preview_width: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_height" { return ::std::option::Option::None; } let preview_height: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "delete_target" { return ::std::option::Option::None; } let delete_target: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "diff_from" { return ::std::option::Option::None; } let diff_from: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "diff" { return ::std::option::Option::None; } let diff: ::std::vec::Vec<crate::host::FsDiffEntry> = (match __value { ::ui_lang_guest::wire::SnapshotValue::List(__items) => __items.into_iter().map(|__item| (|| { let ::ui_lang_guest::wire::SnapshotValue::Record { name: __name, fields: __fields } = __item else { return ::std::option::Option::None; }; if __name != "FsDiffEntry" || __fields.len() != 2 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __field_0) = __fields.next()?; if __name != "path" { return ::std::option::Option::None; } let (__name, __field_1) = __fields.next()?; if __name != "kind" { return ::std::option::Option::None; } ::std::option::Option::Some(crate::host::FsDiffEntry { path: (match __field_0 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?, kind: (match __field_1 { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })? }) })()).collect::<::std::option::Option<::std::vec::Vec<_>>>(), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "acting" { return ::std::option::Option::None; } let acting: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "saving" { return ::std::option::Option::None; } let saving: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "notice" { return ::std::option::Option::None; } let notice: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "new_name" { return ::std::option::Option::None; } let new_name: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "draft" { return ::std::option::Option::None; } let draft: ::ui_lang_guest::Editor = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bytes(bytes) => ::ui_lang_guest::Editor::restore(&bytes), _ => None })?; let (__name, __value) = __fields.next()?; if __name != "editing" { return ::std::option::Option::None; } let editing: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "draft_chain" { return ::std::option::Option::None; } let draft_chain: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "draft_path" { return ::std::option::Option::None; } let draft_path: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "draft_base" { return ::std::option::Option::None; } let draft_base: ::std::string::String = (match __value { ::ui_lang_guest::wire::SnapshotValue::Str(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "draft_id" { return ::std::option::Option::None; } let draft_id: i64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::I64(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "sent" { return ::std::option::Option::None; } let sent: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "viewport_width" { return ::std::option::Option::None; } let viewport_width: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "viewport_height" { return ::std::option::Option::None; } let viewport_height: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "tree_width" { return ::std::option::Option::None; } let tree_width: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "preview_pane_height" { return ::std::option::Option::None; } let preview_pane_height: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "object_width" { return ::std::option::Option::None; } let object_width: f64 = (match __value { ::ui_lang_guest::wire::SnapshotValue::F64(__item) if __item.is_finite() => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; let (__name, __value) = __fields.next()?; if __name != "__ice_component_046696c657353637265656e" { return ::std::option::Option::None; } let __ice_component_046696c657353637265656e: ::std::collections::HashMap<::std::string::String, __IceFilesScreenState> = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record {name: __name, fields: __fields} = __value else { return ::std::option::Option::None; }; if __name != "FilesScreen instances" { return ::std::option::Option::None; } let mut __values = ::std::collections::HashMap::new(); for (__scope, __value) in __fields { let __component = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record {name: __name, fields: __fields} = __value else { return ::std::option::Option::None; }; if __name != "FilesScreen" || __fields.len() != 1 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __value) = __fields.next()?; if __name != "history_open" { return ::std::option::Option::None; } let history_open: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; ::std::option::Option::Some(__IceFilesScreenState {history_open: history_open,__ice_rev: [::ui_lang_runtime::rev::seed(); 1],}) })())?; if __values.insert(__scope, __component).is_some() { return ::std::option::Option::None; } } ::std::option::Option::Some(__values) })())?; let (__name, __value) = __fields.next()?; if __name != "__ice_component_046696c657353637265656e_initial" { return ::std::option::Option::None; } let __ice_component_046696c657353637265656e_initial: __IceFilesScreenState = ((|| { let ::ui_lang_guest::wire::SnapshotValue::Record {name: __name, fields: __fields} = __value else { return ::std::option::Option::None; }; if __name != "FilesScreen" || __fields.len() != 1 { return ::std::option::Option::None; } let mut __fields = __fields.into_iter(); let (__name, __value) = __fields.next()?; if __name != "history_open" { return ::std::option::Option::None; } let history_open: bool = (match __value { ::ui_lang_guest::wire::SnapshotValue::Bool(__item) => ::std::option::Option::Some(__item), _ => ::std::option::Option::None })?; ::std::option::Option::Some(__IceFilesScreenState {history_open: history_open,__ice_rev: [::ui_lang_runtime::rev::seed(); 1],}) })())?; ::std::option::Option::Some(Self::__restore_state(active_palette, connected, dark, chain, generation, route_serial, path, listed, entries, directories, history, omitted, diff_omitted, preview_path, preview_entry, preview_base, preview_text, preview_display_text, preview_clipped, preview_truncated, preview_binary, preview_picture, preview_width, preview_height, delete_target, diff_from, diff, acting, saving, notice, new_name, draft, editing, draft_chain, draft_path, draft_base, draft_id, sent, viewport_width, viewport_height, tree_width, preview_pane_height, object_width, __ice_component_046696c657353637265656e, __ice_component_046696c657353637265656e_initial)) })()).ok_or_else(|| ::std::string::String::from("snapshot state mismatch")) }
}
}
__ice_generated_items_46696c657356696577! {
#[allow(unused_parens)]
...
#[allow(unused_parens)]
impl FilesView {
fn __subscription(&self) -> ::iced::Subscription<__FilesViewMessage> {
::iced::Subscription::batch([
crate::host::session().map(move |__value| __FilesViewMessage::SessionArrived(__value)),
if self.connected { ::iced::Subscription::batch([crate::host::listing(self.generation, self.path.to_owned()).map(move |__value| __FilesViewMessage::ListingArrived(__value)),
]) } else { ::iced::Subscription::none() },
if (self.connected && (!(self.preview_path).is_empty())) { ::iced::Subscription::batch([crate::host::preview(self.generation, self.preview_path.to_owned()).map(move |__value| __FilesViewMessage::PreviewArrived(__value)),
]) } else { ::iced::Subscription::none() },
if (self.connected && (!(self.diff_from).is_empty())) { ::iced::Subscription::batch([crate::host::diff(self.generation, self.diff_from.to_owned()).map(move |__value| __FilesViewMessage::DiffArrived(__value)),
]) } else { ::iced::Subscription::none() },
