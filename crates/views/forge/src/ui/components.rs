...
impl super::ForgeView {
    ...
    pub(super) fn render_pr_state_plate_39(&self, use_scope: String, arg_0: String) -> wire::Node {
        let node_scope = format!("{}/root", use_scope);
        {
            let mut children: Vec<wire::Node> = Vec::new();
            if arg_0 == "open" {
            ...
            let mut children: Vec<wire::Node> = vec![
                wire::Node::Button {
                    ...
                    content: wire::ButtonContent::Child(Box::new(native::padded(
                        native::sized(
                            native::container(format!("{}/@container:521", use_scope), {
                                let mut children: Vec<wire::Node> = Vec::new();
                                if arg_0.kind == "pr" {
                                    children.push(self.render_pr_state_plate_39(
                                        format!("{}/PrStatePlate@1703", use_scope),
                                        arg_0.state.to_owned(),
                                    ));
                                }
                                if !(arg_0.kind == "pr") && arg_0.kind == "issue" {
                                    children.push(self.render_issue_state_glyph_42(
                                ...
                                children.push({
                                    let mut children: Vec<wire::Node> = vec![
                                        native::sized(
                                            native::text_options(
                                                native::text(
                                                    format!("{}/@text:539", use_scope),
                                                    arg_0.title.to_owned().to_string(),
                                                ),
                                                wire::TextOptions {
                                                    wrapping: Some(wire::Wrapping::None),
                                                    ..Default::default()
                                            ...
                                            let mut children: Vec<wire::Node> = vec![
                                                {
                                                    let mut children: Vec<wire::Node> = vec![
                                                        ...
                                                        native::text_options(
                                                            native::text(
                                                                format!("{}/@text:554", use_scope),
                                                                arg_0.number.to_string(),
                                                            ),
                                                            wire::TextOptions {
                                                                wrapping: Some(
                                                                    wire::Wrapping::None,
                                                ...
                                                native::text_options(
                                                    native::text(
                                                        format!("{}/@text:566", use_scope),
                                                        arg_0.author_name.to_owned().to_string(),
                                                    ),
                                                    wire::TextOptions {
                                                        wrapping: Some(wire::Wrapping::None),
                                                        ..Default::default()
                    ...
                    on_press: Some(::ducktape_view_guest::slots::message(cb_0(arg_0.number))),
                    width: Some(wire::Length::Fill),
                    height: None,
                ...
                native::sized(
                    native::container(
                        format!("{}/@container:575", use_scope),
                        wire::Node::Space {
                            width: Some(wire::Length::Fixed(1.0f32)),
                            height: Some(wire::Length::Fixed(1.0f32)),
                        },
        ...
        let node_scope = format!("{}/root", use_scope);
        {
                ...
                children.push(native::padded(
                    native::sized(
                        native::container(
                            ...
                            self.loading_tracker(format!("{}/EmptyPlate@2715", use_scope)),
                        ),
                        Some(wire::Length::Fill),
                        None,
                    ),
                ...
                children.push(native::padded(
                    native::sized(
                        native::container(
                            ...
                            self.tracker_unavailable(format!("{}/EmptyPlate@2718", use_scope)),
                        ),
                        Some(wire::Length::Fill),
                        None,
                    ),
                ...
                && self.repo_phase == "ready"
            {
                children.push({
                        ...
                        children.push(native::padded(
                            native::sized(
                                native::container(
                                    ...
                                    self.empty_issues(format!("{}/EmptyPlate@2725", use_scope)),
                                ),
                                Some(wire::Length::Fill),
                                None,
                            ),
                    ...
                    .is_empty()
                    {
                        children.push(wire::Node::Scroll {
                            ...
                            content: Box::new({
                                ...
                                .enumerate()
                                {
                                    let for_scope = format!("{}/@for:2740({})", use_scope, index);
                    ...
                    native::sized(
                        native::column(format!("{}/@layout:1554", use_scope), children),
                        Some(wire::Length::Fill),
                        Some(wire::Length::Fill),
                    )
                });
                    ...
                    .is_empty()
                    {
                        children.push(native::padded(
                            native::sized(
                                native::container(
                                    format!("{}/@container:1556", use_scope),
                                    self.empty_pulls(format!("{}/EmptyPlate@2725", use_scope)),
                                ),
                                Some(wire::Length::Fill),
                                None,
                            ),
    ...
    pub(super) fn render_pr_state_pill_49(&self, use_scope: String) -> wire::Node {
        let node_scope = format!("{}/root", use_scope);
        {
            ...
            if self.forge_item_state == "open" {
                children.push(native::padded(
                    native::container(format!("{}/@container:720", use_scope), {
                        let mut children: Vec<wire::Node> = vec![
                            self.icon(
                            ...
                            native::text_options(
                                native::text(
                                    format!("{}/@text:734", use_scope),
                                    "Open".to_owned().to_string(),
                                ),
                                wire::TextOptions {
                                    wrapping: Some(wire::Wrapping::None),
                                    ..Default::default()
            ...
            if !(self.forge_item_state == "open") && self.forge_item_state == "merged" {
                children.push(native::padded(
                    native::container(format!("{}/@container:741", use_scope), {
                        let mut children: Vec<wire::Node> = vec![
                            self.icon(
                            ...
                            native::text_options(
                                native::text(
                                    format!("{}/@text:755", use_scope),
                                    "Merged".to_owned().to_string(),
                                ),
                                wire::TextOptions {
                                    wrapping: Some(wire::Wrapping::None),
                                    ..Default::default()
            ...
            if !(self.forge_item_state == "open" || self.forge_item_state == "merged") {
                children.push(native::padded(
                    native::container(format!("{}/@container:762", use_scope), {
                        let mut children: Vec<wire::Node> = vec![
                            self.icon(
                            ...
                            native::text_options(
                                native::text(
                                    format!("{}/@text:776", use_scope),
                                    "Closed".to_owned().to_string(),
                                ),
                                wire::TextOptions {
                                    wrapping: Some(wire::Wrapping::None),
                                    ..Default::default()
        ...
        let node_scope = format!("{}/root", use_scope);
        {
            let mut children: Vec<wire::Node> = vec![
                ...
                native::sized(
                    native::text_options(
                        native::text(
                            format!("{}/@text:929", use_scope),
                            crate::host::forge_merge_note(
            ...
            if self.forge_item_change_requests == 1 {
                children.push({
                    let mut children: Vec<wire::Node> = vec![
                        native::sized(
                            native::container(
                                format!("{}/@container:950", use_scope),
                                wire::Node::Space {
                                    width: Some(wire::Length::Fixed(1.0f32)),
                                    height: Some(wire::Length::Fixed(1.0f32)),
                                },
            ...
            if self.forge_item_change_requests > 1 {
                children.push({
                    let mut children: Vec<wire::Node> = vec![
                        native::sized(
                            native::container(
                                format!("{}/@container:968", use_scope),
                                wire::Node::Space {
                                    width: Some(wire::Length::Fixed(1.0f32)),
                                    height: Some(wire::Length::Fixed(1.0f32)),
                                },
                        ...
                        native::text_options(
                            native::text(
                                format!("{}/@text:975", use_scope),
                                self.forge_item_change_requests.to_string(),
                            ),
                            wire::TextOptions {
                                wrapping: Some(wire::Wrapping::None),
                                ..Default::default()
        ...
        let node_scope = format!("{}/root", use_scope);
        {
            ...
            if self.merge_busy {
                children.push(wire::Node::Button {
                    ...
                    content: wire::ButtonContent::Child(Box::new({
                        let mut children: Vec<wire::Node> = vec![native::text_options(
                            native::text(
                                format!("{}/@text:1002", use_scope),
                                "Merging…".to_owned().to_string(),
                            ),
                            wire::TextOptions {
                                wrapping: Some(wire::Wrapping::None),
                                ..Default::default()
                ...
                children.push(wire::Node::Button {
                    ...
                    content: wire::ButtonContent::Child(Box::new({
                        let mut children: Vec<wire::Node> = vec![
                            ...
                            native::text_options(
                                native::text(
                                    format!("{}/@text:1023", use_scope),
                                    "Merge pull request".to_owned().to_string(),
                                ),
                                wire::TextOptions {
                                    wrapping: Some(wire::Wrapping::None),
                                    ..Default::default()
    ...
    pub(super) fn render_review_verdict_71(&self, use_scope: String, arg_0: String) -> wire::Node {
        let node_scope = format!("{}/root", use_scope);
        {
            let mut children: Vec<wire::Node> = Vec::new();
            if arg_0 == "approve" {
                children.push(native::text_options(
                    native::text(
                        ...
                        crate::host::verdict_label(::std::convert::AsRef::as_ref(&arg_0))
                            .to_string(),
                    ),
                    wire::TextOptions {
                        wrapping: Some(wire::Wrapping::None),
                ...
                native::container(node_scope.clone(), {
                    let mut children: Vec<wire::Node> = vec![{
                        let mut children: Vec<wire::Node> = vec![
                            ...
                            self.render_review_verdict_71(
                                format!("{}/ReviewVerdict@2615", use_scope),
                                arg_0.verdict.to_owned(),
                            ),
                            native::text_options(
                                native::text(
                                    format!("{}/@text:1448", use_scope),
                                    arg_0.commit.to_owned().to_string(),
                                ),
                                wire::TextOptions {
                                    wrapping: Some(wire::Wrapping::None),
                                    ..Default::default()
                        ...
                        if arg_0.outdated {
                            children.push(native::padded(
                                native::container(
                                    format!("{}/@container:1455", use_scope),
                                    native::text_options(
                                        native::text(
                                            format!("{}/@text:1461", use_scope),
                                            "outdated".to_owned().to_string(),
                                        ),
                                        wire::TextOptions {
                                            wrapping: Some(wire::Wrapping::None),
                                            ..Default::default()
                    ...
                    for (index, comment) in arg_0.comments.iter().enumerate() {
                        ...
                        children.push(native::padded(
                            native::sized(
                                native::container(format!("{}/@container:1474", for_scope), {
                                    let mut children: Vec<wire::Node> = vec![
                                        {
                                            let mut children: Vec<wire::Node> = vec![
                                                native::sized(
                                                    native::text_options(
                                                        native::text(
                                                            format!("{}/@text:1491", for_scope),
                                                            comment.anchor.to_owned().to_string(),
                                                        ),
                                                        wire::TextOptions {
                                                            wrapping: Some(wire::Wrapping::None),
                                                            ..Default::default()
                                                ...
                                                native::text_options(
                                                    native::text(
                                                        format!("{}/@text:1498", for_scope),
                                                        "review comment".to_owned().to_string(),
                                                    ),
                                                    wire::TextOptions {
                                                        wrapping: Some(wire::Wrapping::None),
                                                        ..Default::default()
                    ...
                    native::spaced(
                        native::sized(
                            native::column(format!("{}/@layout:1435", use_scope), children),
                            Some(wire::Length::Fill),
                            None,
                        ),
                        6.0f32,
