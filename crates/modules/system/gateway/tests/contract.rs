...
fn signing_preimage_has_a_cross_language_fixed_vector() {
    ...
    assert_eq!(
        encoded,
        "040000000000000074657374020000000000000001020103000000000000006170692000000000000000030303030303030303030303030303030303030303030303030303030303030307000000000000000102030000000000000001020300040000000000000010000000000000000102"
    );
}
...
fn content_route_preimage_binds_only_the_manifest_hash() {
    ...
    assert_eq!(
        encoded,
        ""
    );
}
