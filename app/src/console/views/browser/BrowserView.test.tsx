...
describe("BrowserView security boundary", () => {
  ...
  it("describes one route abstraction", () => {
    ...
    expect(screen.getByRole("complementary", { name: "Gateway publishing" })).toBeInTheDocument();
    expect(screen.getByText(/One signed route can serve exact DuckFS files/)).toBeInTheDocument();
  });
});
