...
/// (and the forge view's, over the data the guest hands across)
...
impl Guest {
    ...
    /// app's own ring (or the chat composer's submit), whose event was queued
    ...
    fn deliver(&mut self, output: Output) {
        ...
        } = output
        {
            match self.module {
                ...
                _ => self.intents.push(ModuleViewEvent {
