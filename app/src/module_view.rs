...
/// goes back to the guest's handler), and the highlighted code. The files
/// view's three are the preview's readers: the picture viewer over the
/// Files surface's store, the highlighted code reader, and the Markdown
/// document, whose activated link goes back to the guest's own handler.
