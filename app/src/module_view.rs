...
/// activated link goes back to the guest's own handler as a string. The
/// shell view's three: the terminal for the session the app parked, the
/// same Markdown reader for its answers, and the composer
