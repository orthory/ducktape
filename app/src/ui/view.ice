    ...
    if console_win == some(window)
      WorkspaceTabs wall_now=wall_now #workspace-tabs
        ...
        agents:
          ...
          // signs
          extern agents_view(dark, connected, agents_answered, account_number, agents_committed, agents_rows, agents_runs, agents_journal, agents_capabilities, agents_actions) #agents -> agents_view_event _
