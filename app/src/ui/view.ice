    ...
    if console_win == some(window)
      WorkspaceTabs wall_now=wall_now #workspace-tabs
        ...
        agents:
          ...
          // signs
          extern agents_view(dark, connected, agents_answered, account_number, agents_committed, agents_rows, agents_capabilities, agents_actions, messaging, messaging_loading, messaging_sending, messaging_send_error, messaging_sent) #agents -> agents_view_event _
