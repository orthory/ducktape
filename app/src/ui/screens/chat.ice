            ...
            if !channel_create_open
              button -> emit(toggle_channel_create)
                with
                  ...
                  p=0.0
                  @icon_action
                svg icon("plus") memory color=inherit w=16.0 h=16.0
