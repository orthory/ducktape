extern crate::backend
  ...
  LiveAgentNotice(rpc:str, rows:[LiveAgentRow])
  ...
  stream chat_live_agents(rpc:str) -> LiveAgentNotice
  pure live_agents_of(notice:&LiveAgentNotice, rpc:&str) -> [LiveAgentRow]
