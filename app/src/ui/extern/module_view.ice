...
extern crate::module_view
  ...
  component agents_view(dark:bool, connected:bool, answered:bool, account:&str, committed:i64, rows:&[AgentRow], runs:&[RunRow], open_run:&str, journal:&RunJournal, live:&LiveRun, capabilities:&[str], actions:&[str], messaging:&MessagingView, messaging_loading:bool, messaging_sending:bool, messaging_send_error:&str, messaging_sent:i64) -> ModuleViewEvent
