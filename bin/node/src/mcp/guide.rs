...
modules.update is a final-response action, not a live tool: commit the Wasm \
artifact in your Forge checkout and follow the output contract. Ducktape binds \
